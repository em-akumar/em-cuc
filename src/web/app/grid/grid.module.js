...
let gridModule = angular.module('grid', ['ui.grid', 'ui.grid.moveColumns', 'ui.grid.pagination', 'ui.grid.selection', 'ui.grid', 'ui.grid.edit', 'ui.grid.exporter', 'ui.grid.resizeColumns','ui.grid.saveState']);
