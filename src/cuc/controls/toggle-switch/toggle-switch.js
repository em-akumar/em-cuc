...
class ToggleSwitch {
    static load() {
            ...
            BootstrapSwitch = (function () {
                function BootstrapSwitch(element, options) {
                    ...
                    this.options = $.extend({}, $.fn.bootstrapSwitch.defaults, {
                        ...
                        logicSwitch: this.$element.data("logic-switch"),
                        onImage: this.$element.data("on-image"),
                        offImage: this.$element.data("off-image")
                    }, options);
                    this.prevOptions = {};
                    this.$wrapper = $("<div>", {
                    ...
                    this.$container = $("<div>", {
                        "class": (this.options.baseClass + "-container " + (this.options.logicSwitch ? 'logic-switch' : ''))
                    });
                    this.$on = $("<span>", {
                        html: this.options.onText || '',
                        "class": this.options.baseClass + "-handle-on " + (this.options.onImage ? this.options.onImage : '') + ' ' + this.options.baseClass + "-" + this.options.onColor
                    });
                    this.$off = $("<span>", {
                        html: this.options.offText || '',
                        "class": this.options.baseClass + "-handle-off " + (this.options.offImage ? this.options.offImage : '') + ' ' + this.options.baseClass + "-" + this.options.offColor
                    });
                    this.$label = $("<span>", {
                ...
                BootstrapSwitch.prototype.setPrevOptions = function () {
                    this.prevOptions = $.extend(true, {}, this.options);
        ...
        $('.toggle[type="checkbox"]').bootstrapSwitch();
    }
}
